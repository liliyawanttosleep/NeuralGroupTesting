...
class BestModelFinderWithTesting:
    ...
    def find_best_model(self):
        ...
        for _ in range(self.B):
            ...
            # Testing a single matrix 100 times and averaging the score
            for _ in range(100):
            ...
            average_score = total_score / (self.H * 100)
...
if __name__ == "__main__":
    finder = BestModelFinderWithTesting(n=1000, d=2, delta=0.1, B=10, H=10)
